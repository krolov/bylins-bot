...
<required_reading>
@/home/user/bylins-bot/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@/home/user/bylins-bot/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/user/bylins-bot/.claude
                  → checks /home/user/bylins-bot/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/user/bylins-bot/.claude/get-shit-done
                  → writes to /home/user/bylins-bot/.claude/get-shit-done/hooks/
...
@/home/user/bylins-bot/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/home/user/bylins-bot/.claude/get-shit-done/references/common-bug-patterns.md
