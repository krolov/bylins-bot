...
Use template from `/home/user/bylins-bot/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/home/user/bylins-bot/.claude/get-shit-done/templates/UI-SPEC.md`
