...
@/home/user/bylins-bot/.claude/get-shit-done/references/thinking-models-research.md
...
```bash
node "/home/user/bylins-bot/.claude/get-shit-done/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```
