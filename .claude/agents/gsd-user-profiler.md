...
<reference>
@/home/user/bylins-bot/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/user/bylins-bot/.claude/get-shit-done/references/user-profiling.md` to load:
