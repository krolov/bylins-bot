...
Reference full template: `/home/user/bylins-bot/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/user/bylins-bot/.claude/get-shit-done/templates/state.md`.
