...
```
Task(
  prompt="Read /home/user/bylins-bot/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/user/bylins-bot/.claude/get-shit-done/templates/VALIDATION.md`
