...
```markdown
Read /home/user/bylins-bot/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/user/bylins-bot/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/user/bylins-bot/.claude/agents/gsd-ui-checker.md for instructions.
