...
<execution_context>
@/home/user/bylins-bot/.claude/get-shit-done/workflows/pr-branch.md
</execution_context>

<process>
Execute the pr-branch workflow from @/home/user/bylins-bot/.claude/get-shit-done/workflows/pr-branch.md end-to-end.
</process>
