...
<execution_context>
@/home/user/bylins-bot/.claude/get-shit-done/workflows/manager.md
...
<process>
Execute the manager workflow from @/home/user/bylins-bot/.claude/get-shit-done/workflows/manager.md end-to-end.
