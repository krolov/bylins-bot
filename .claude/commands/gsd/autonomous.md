...
<execution_context>
@/home/user/bylins-bot/.claude/get-shit-done/workflows/autonomous.md
...
<process>
Execute the autonomous workflow from @/home/user/bylins-bot/.claude/get-shit-done/workflows/autonomous.md end-to-end.
