...
<execution_context>
@/home/user/bylins-bot/.claude/get-shit-done/workflows/code-review-fix.md
</execution_context>
...
Execute the code-review-fix workflow from @/home/user/bylins-bot/.claude/get-shit-done/workflows/code-review-fix.md end-to-end.
