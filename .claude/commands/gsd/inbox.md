...
<execution_context>
@/home/user/bylins-bot/.claude/get-shit-done/workflows/inbox.md
</execution_context>
...
<process>
Execute the inbox workflow from @/home/user/bylins-bot/.claude/get-shit-done/workflows/inbox.md end-to-end.
