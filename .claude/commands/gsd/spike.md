...
<execution_context>
@/home/user/bylins-bot/.claude/get-shit-done/workflows/spike.md
...
<process>
Execute the spike workflow from @/home/user/bylins-bot/.claude/get-shit-done/workflows/spike.md end-to-end.
