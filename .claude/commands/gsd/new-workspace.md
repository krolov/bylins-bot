...
<execution_context>
@/home/user/bylins-bot/.claude/get-shit-done/workflows/new-workspace.md
@/home/user/bylins-bot/.claude/get-shit-done/references/ui-brand.md
</execution_context>

<process>
Execute the new-workspace workflow from @/home/user/bylins-bot/.claude/get-shit-done/workflows/new-workspace.md end-to-end.
